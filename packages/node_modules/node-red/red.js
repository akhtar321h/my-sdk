...
// --help //
if (parsedArgs.help) {
    console.log("Trinity IOT-SDK v"+RED.version());
...
if (parsedArgs.settings) {
    ...
    } else if (process.env.HOMEPATH && fs.existsSync(path.join(process.env.HOMEPATH,".tIOTSDK",".config.json"))) {
        // Consider compatibility for older versions
        settingsFile = path.join(process.env.HOMEPATH,".tIOTSDK","settings.js");
        //Akhtar edit
        //newFlowFile= path.join(process.env.HOMEPATH,".tIOTSDK","myFlow.json");
    } else {
        var userDir = parsedArgs.userDir || path.join(process.env.HOME || process.env.USERPROFILE || process.env.HOMEPATH,".tIOTSDK");
        var userSettingsFile = path.join(userDir,"settings.js");
        //var myFlowFile = path.join(userDir,"myFLow.js");
...
httpsPromise.then(function(startupHttps) {
    ...
    try {
        ...
        if (err.code == "unsupported_version") {
            ...
            console.log("Trinity IOT-SDK requires Node.js v8.9.0 or later");
        } else {
